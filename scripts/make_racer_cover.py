#!/usr/bin/env python3
"""Neon Drift Racers itch.io cover (630x500).

Built from a real in-game frame (marketing/racer/shot-raw-cover.png, captured
...
OUT = os.path.join(ROOT, "marketing", "racer")
...
def main():
    ...
    base = Image.composite(Image.new("RGB", (W, H), (4, 5, 14)), base, scrim)

    d = ImageDraw.Draw(base)

    def centered(y, txt, f, fill, stroke=(4, 5, 14), sw=3):
        bb = d.textbbox((0, 0), txt, font=f)
        x = (W - (bb[2] - bb[0])) / 2 - bb[0]
        d.text((x, y), txt, font=f, fill=fill, stroke_width=sw, stroke_fill=stroke)

    centered(14, "NEON", font(50), (255, 255, 255))
    centered(62, "DRIFT RACERS", font(52), (18, 242, 228))
    centered(122, "Drift · Boost · Race the world", font(19), (226, 232, 250), (4, 5, 14), 2)

    # badge so the "online" hook survives being shrunk to a store thumbnail
    tag = "RACE THE WORLD WITH RACE CODES"
    f2 = font(15)
