...
def render_index(arts):
    ...
    tool = ('<div class="cards"><a class="gcard" href="%s/tools/ai-policy/">'
            ...
            '</a><a class="gcard" href="%s/ember/">'
            '<h2>Free app: Ember</h2>'
            '<p>A focus timer with a dragon. Stay with the session and it is fed and '
            'grows; leave the app and the ember fades. Offline, no account, nothing '
            'leaves your phone.</p>'
            ...
            'Singapore salary in ringgit at today\'s rate, what the commute really '
            'costs each month, and a residency day counter that understands you are '
            'in both countries on the same day. Everything stays on your phone.</p>'
            ...
            '</a></div>' % (SITE, SITE, SITE, SITE, SITE))
